...
@section('panel')
    <div class="panel-heading container-fluid">
        ...
        <a class="btn btn-info btn-xs col-md-1 col-sm-2 col-xs-2" href="{{ route('portfolioAlls.index', compact('portfolio')) }}">
    ...
    <div class="panel-body">
        {!! Form::open(['route' => ['portfolioAlls.store', 'portfolio' => $portfolio], 'method'=> 'POST', 'enctype' => 'multipart/form-data', 'file'=>true]) !!}                     
